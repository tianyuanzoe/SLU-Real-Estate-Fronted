    ...
    function ReducerFunction(draft, action) {
        switch (action.type) {
            ...
            case 'catchPasswordChange':
				 ...
				 draft.passwordErrors.hasError = false
			...
			case 'numericPassword':
				draft.serverMessageNumericPassword = 'The password must not contain only numbers'
				break			
        ...
        <form onSubmit={FormSubmit}>
            ...
            <Grid item container
                ...
                <TextField id="username" label="Username" variant="outlined" fullWidth
                    ...
                    onChange=
                    {(e)=>dispatch({type:"catchUsernameChange",usernameChosen:e.target.value})}
                    onBlur=
                    {(e)=>dispatch({type:"catchUsernameErrors",usernameChosen:e.target.value})}
                    error={
                        state.usernameErrors.hasError ? true : false
                    }
                    helperText={
                        state.usernameErrors.errorMessage
                    }/>
            </Grid>
            ...
            <Grid item container
                ...
                <TextField id="email" label="Email" variant="outlined" fullWidth
                    ...
                    onChange=
                    {(e)=>dispatch({type:"catchEmailChange",emailChosen:e.target.value})}
                    onBlur=
                    {(e)=>dispatch({type:"catchEmailErrors",emailChosen:e.target.value})}
                    error={
                        state.emailErrors.hasError ? true : false
                    }
                    helperText={
                        state.emailErrors.errorMessage
                    }/>
            </Grid>
            <Grid item container
                style={
                ...
                <TextField id="password" label="Password" variant="outlined" fullWidth type="password"
                    ...
                    onChange=
                    {(e)=>dispatch({type:"catchPasswordChange",passwordChosen:e.target.value})}
					onBlur=
                    {(e)=>dispatch({type:"catchPasswordErrors",passwordChosen:e.target.value})}
					error={
                        state.passwordErrors.hasError ? true : false
                    }
                    helperText={
                        state.passwordErrors.errorMessage
                    }
					/>
            </Grid>
            <Grid item container
                ...
                <TextField id="password2" label="ConfirmPassword" variant="outlined" fullWidth type="password"
                    value={
                        state.password2Value
                    }
                    onChange=
                    {(e)=>dispatch({type:"catchPassword2Change",password2Chosen:e.target.value})}
